<?php
	...
	{
		$id = $_GET['edit_id'];
		$stmt_edit = $DB_con->prepare('SELECT srNo, firstName, lastName, rollNo, fatherName, motherName, userGender, userCast, DOB, userClass, userAddress, userMobile, userEmail, userAadhar, userPic FROM school_students WHERE userID =:uid');
	...
	if(isset($_POST['btn_save_updates']))
	{
		...
		$classname = $_POST['class_name'];// user name
		...
		if(!isset($errMSG))
		{
			$stmt = $DB_con->prepare("UPDATE school_students 
									     SET srNo=:name,
										     firstName=:fname,
											 rollNo=:rname,
											 lastName=:lname,
...
<form method="post" enctype="multipart/form-data" class="form-horizontal">
    ...
    <tr>
    	<td><label class="control-label" style="text-align:center;">SR no</label></td>
        <td><input class="form-control" type="text" name="sr_name" value="<?php echo $srNo; ?>" required /></td>
    </tr>
	...
	<tr>
    	<td><label class="control-label" style="text-align:center;">Mother's name</label></td>
        <td><input class="form-control" type="text" name="mother_name" value="<?php echo $motherName; ?>" required /></td>
    </tr>
	<tr>
	...
	<tr>
    	<td><label class="control-label" style="text-align:center;">Class</label></td>
        <td><input class="form-control" type="text" name="class_name" value="<?php echo $userClass; ?>" required /></td>
    </tr>
	<tr>
    	<td><label class="control-label" style="text-align:center;">Roll No</label></td>
        <td><input class="form-control" type="text" name="roll_name" value="<?php echo $rollNo; ?>" required /></td>
    </tr>
	<tr>
    ...
    <tr>
        ...
        <a class="btn btn-default" href="tab-panel.php"> <span class="glyphicon glyphicon-backward"></span> cancel </a>
